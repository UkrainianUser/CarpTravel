...
const CareerInfo = () => {
	return (
		<section className="h-full py-14 bg-[url('/bg-career-mobile.jpg')] bg-cover">
			<Container>
				<h2 className="mb-5 text-4xl font-thin uppercase tracking-wide">
					Choose
					<span className="text-4xl font-medium"> us</span>
				</h2>
				<p className="ml-auto mb-9 text-sm font-thin tracking-wide leading-5 w-[180px]">
					Your chance to join our passionate team in Carpathian tourism. Seeking
					talented professionals to share our common mission.
				</p>
				<p className="ml-auto mb-9 text-3xl font-thin uppercase tracking-wide w-[180px]">
					Why us ?
				</p>
				<ul className="mb-9 text-xs font-thin text-right tracking-wide leading-5 w-[180px]">
					<li>
